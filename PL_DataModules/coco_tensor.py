...
from models.data.datasets.cocoTensorDataset import COCOTensorDataset
...
class COCOTensorDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        self.dataset_train = COCOTensorDataset(
            self.data_dir,
            name=self.train_dir,
    ...
    def val_dataloader(self):
        self.dataset_val = COCOTensorDataset(
            self.data_dir,
            name=self.val_dir,
    ...
    def test_dataloader(self):
        self.dataset_test = COCOTensorDataset(
            self.data_dir,
            name=self.test_dir,
