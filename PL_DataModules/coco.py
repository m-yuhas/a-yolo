...
class COCODataModule(pl.LightningDataModule):
    """Lightning data module for an object detection dataset with COCO
    annotations.

    Args:
        cfgs - configuration dictionary.  See configs/data for example
        configuration YAML files.  Accepted keys are:
            dataset: Dictionary containing dataset paths for test, train, and val.
            transform: transforms to apply
            classes: list of classes
    """

    def __init__(self, cfgs: Dict[str, Any]) -> None:
        super().__init__()
    ...
    def train_dataloader(self) -> torch.utils.data.DataLoader:
        ...
        train_loader = DataLoader(
            ...
            shuffle=True,
            num_workers=6, #TODO: determine this based on CPU architecture
            pin_memory=True,
